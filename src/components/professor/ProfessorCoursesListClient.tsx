      ...
      {showCreate && (
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            <p className="text-sm font-semibold text-gray-900">Create a new course</p>
          ...
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 text-sm border border-gray-200 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-gray-200 bg-gray-50"
              autoFocus
            />
            <button
              onClick={handleCreate}
              disabled={creating || !newName.trim()}
              className="inline-flex items-center gap-2 bg-gray-900 hover:bg-gray-800 disabled:opacity-50 text-white text-sm font-medium px-4 py-2.5 rounded-xl transition"
            >
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              {editingId === course.id ? (
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 text-sm border border-gray-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-gray-200 bg-gray-50"
                    autoFocus
                  />
                  <button
                    onClick={() => handleEdit(course.id)}
                    disabled={saving}
                    className="p-1.5 bg-gray-900 text-white rounded-lg hover:bg-gray-800 disabled:opacity-50 transition"
                  >
              ...
              <div className="flex items-center gap-4 mt-1.5 text-xs text-gray-400">
                ...
                <span className="font-mono">Code: {course.inviteCode}</span>
              </div>
            </div>
