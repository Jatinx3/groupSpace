    ...
    <div className="fixed inset-0 bg-black/50 dark:bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-[#111111] dark:border dark:border-white/10 w-full max-w-xl rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="px-6 py-5 border-b border-gray-100 dark:border-white/10 flex items-center justify-between">
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-widest text-gray-400 dark:text-zinc-500">Editing</p>
            <h2 className="text-base font-bold text-gray-900 dark:text-white mt-0.5">Edit Task</h2>
          </div>
          <button
            onClick={onClose}
            ...
            {!showDeleteConfirm ? (
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <button
                  ...
                  className="px-3 py-1 rounded-lg border border-gray-200 dark:border-white/10 text-xs font-semibold text-gray-900 dark:text-gray-300 transition hover:bg-gray-50 dark:hover:bg-white/5"
                >
                  Cancel
                </button>
              </div>
